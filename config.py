...
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [6650021309]
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/SOURCE_CR")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/POU_V")
