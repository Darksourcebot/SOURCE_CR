...
@app.on_message(
    command(["مميزات","مميزات tnt"])
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس tnt ميوزك\n
⩹━★⊷⌯⌞  ͲΝͲ • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⌯⊶★━⩺

★قايمه مميزات سورس tnt 
            ...
            [
                [
                    InlineKeyboardButton(
                        "★⌞  ͲΝͲ • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡", url=f"https://t.me/ ͲΝͲ"),                        
                 ],[
                InlineKeyboardButton(
