...
GAME_BUTTONS = [
    [ 
        ...
        InlineKeyboardButton ('⌞ ͲΝͲ • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡️', url =f"https://t.me/ TNT_source")              
                 ],[
...
async def zohary(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/4b9ed5dc15f542f448d58.jpg",
